...
- [Android UI redesign](android-ui-redesign.md) — M3 redesign complete; new UiComponents.kt (SkeletonBox/PremiumEmptyState); no Android SDK in Replit so Gradle build can't run locally
